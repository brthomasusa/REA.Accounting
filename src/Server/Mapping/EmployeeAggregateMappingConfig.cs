    ...
    public sealed class EmployeeAggregateMappingConfig : IRegister
    {
        void IRegister.Register(TypeAdapterConfig config)
        {
            ...
            */
            ...
            config.NewConfig<grpc_EmployeeDetailResponse, GetEmployeeDetailsByIdWithAllInfoResponse>()
            ...
            config.NewConfig<GetEmployeeDetailsByIdWithAllInfoResponse, grpc_EmployeeDetailResponse>()
            ...
            config.NewConfig<grpc_EmployeeListItem, GetEmployeeListItemsResponse>()
                .Map(dest => dest.MiddleName, src => string.IsNullOrEmpty(src.MiddleName) ? null : src.MiddleName);

            config.NewConfig<GetEmployeeListItemsResponse, grpc_EmployeeListItem>()
                .Map(dest => dest.MiddleName, src => string.IsNullOrEmpty(src.MiddleName) ? string.Empty : src.MiddleName);
